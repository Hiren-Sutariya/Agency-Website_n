...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Size and position
    const radius = 9.5;
    globeGroup.position.y = -radius * 0.4; // Positioned for 70% visibility
    ...
    const countries = [
        { id: 'IND', lat: 12.9716, lng: 77.5946, label: 'INDIA', sub: 'Global Headquarters', flag: 'in' },
        { id: 'USA', lat: 37.0902, lng: -95.7129, label: 'United States', sub: '120+ Projects', flag: 'us' },
        { id: 'UA', lat: 48.3794, lng: 31.1656, label: 'Ukraine', sub: 'Digital Hub', flag: 'ua' },
        { id: 'UK', lat: 51.5074, lng: -0.1278, label: 'London, UK', sub: 'Fintech HQ', flag: 'gb' },
        { id: 'UAE', lat: 25.2048, lng: 55.2708, label: 'Dubai, UAE', sub: 'Smart Innovation', flag: 'ae' },
        { id: 'JPN', lat: 35.6762, lng: 139.6503, label: 'Tokyo, JPN', sub: 'AI Research', flag: 'jp' },
        { id: 'CAN', lat: 43.6532, lng: -79.3832, label: 'Toronto, CAN', sub: 'Creative Studio', flag: 'ca' },
        { id: 'SGP', lat: 1.3521, lng: 103.8198, label: 'Singapore', sub: 'Data Center', flag: 'sg' },
        { id: 'GER', lat: 52.5200, lng: 13.4050, label: 'Berlin, GER', sub: 'Engineering', flag: 'de' }
    ];
    ...
    const setupMarkersAndArcs = () => {
        ...
        countries.forEach((country, index) => {
            ...
            el.innerHTML = `
                <div class="marker-flag-wrap">
                    <img src="https://purecatamphetamine.github.io/country-flag-icons/3x2/${country.flag.toUpperCase()}.svg" class="marker-flag" alt="${country.label}" onerror="this.src='https://flagcdn.com/w40/${country.flag}.png'">
                </div>
    ...
    const animate = () => {
        ...
        if (hasStartedAnimation && !isDragging && !isMarkerHovered) {
            targetRotationY += 0.001; // Smooth automatic rotation
        }
